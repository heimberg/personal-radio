...
function App() {
  ...
  return <div className="shell">
    ...
    <main>
      <div className="intro"><p className="eyebrow">DEIN PROGRAMM. DEIN RHYTHMUS.</p><h1>{tab === 'radio' ? 'Platz für gute Gedanken.' : tab === 'profile' ? 'So klingt dein Tag.' : 'Hören. Sperren. Testen.'}</h1><p>{tab === 'radio' ? 'Dein Feedback hilft dem Radio, passende Beiträge und Themen für dich auszuwählen.' : tab === 'profile' ? 'Deine Vorlieben bleiben auf diesem Gerät und werden beim Entwurf mitgeschickt.' : 'Finde heraus, wie zuverlässig dein Android-Gerät im Hintergrund weiterspielt.'}</p></div>
      {tab === 'radio' && <>
